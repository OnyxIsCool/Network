local function MainAzureGUI() 
    -- ( Azuree A+ (Powered by Panda Development) START )
    ...
    -- Create Show Button (A button)
    local ShowButton = Instance.new("TextButton")
    ShowButton.Name = "ShowButton"
    ShowButton.Parent = ScreenGui
    ShowButton.BackgroundColor3 = Color3.fromRGB(0, 120, 212) -- Azure Blue
    ...
    ShowButton.MouseEnter:Connect(function()
        TweenService:Create(ShowButton, TweenInfo.new(0.3), {
            BackgroundColor3 = Color3.fromRGB(60, 160, 255) -- Azure Light Hover
        }):Play()
    end)
    
    ShowButton.MouseLeave:Connect(function()
        TweenService:Create(ShowButton, TweenInfo.new(0.3), {
            BackgroundColor3 = Color3.fromRGB(0, 120, 212) -- Azure Blue
        }):Play()
    end)
    
    -- Configure BorderFrame (outer frame with Azure color)
    BorderFrame.Name = "BorderFrame"
    BorderFrame.Parent = ScreenGui
    BorderFrame.BackgroundColor3 = Color3.fromRGB(0, 120, 212) -- Azure Blue
    ...
    Logo.Image = "rbxassetid://101899401380639"
    ...
    local function createNavButton(name, position)
        ...
        local function updateStyle()
            button.TextColor3 = isSelected and Color3.fromRGB(0, 120, 212) or Color3.fromRGB(255, 255, 255) -- Azure Text
        end
        ...
        button.MouseEnter:Connect(function()
            if not isSelected then
                TweenService:Create(button, TweenInfo.new(0.3), {
                    TextColor3 = Color3.fromRGB(0, 120, 212) -- Azure Hover Text
                }):Play()
            end
        end)
    ...
    AddTabButton.BackgroundColor3 = Color3.fromRGB(0, 120, 212) -- Azure Blue
    ...
    AddTabButton.MouseEnter:Connect(function()
        TweenService:Create(AddTabButton, TweenInfo.new(0.3), {
            BackgroundColor3 = Color3.fromRGB(60, 160, 255) -- Azure Hover
        }):Play()
    end)
    ...
    local function createTab()
        ...
        tabStroke.Color = Color3.fromRGB(0, 120, 212) -- Azure Stroke
        ...
        tab.button.MouseButton1Click:Connect(function()
            ...
            currentTab = tab
            TweenService:Create(tab.button, TweenInfo.new(0.3), {
                BackgroundColor3 = Color3.fromRGB(0, 120, 212) -- Azure Active Tab
            }):Play()
    ...
    local function createButton(name, position)
        ...
        button.BackgroundColor3 = Color3.fromRGB(0, 120, 212) -- Azure Blue
    ...
    local function createSettingOption(name, position)
        ...
        checkbox.MouseButton1Click:Connect(function()
            ...
            local checkboxColor = checked and Color3.fromRGB(0, 120, 212) or Color3.fromRGB(45, 45, 49) -- Azure Toggle
    ...
    CategoryTitle.TextColor3 = Color3.fromRGB(0, 120, 212) -- Azure Category Title
    ...
    createInfoLabel("Premium:", "No", 125)
    ...
    blur.Enabled = true
    -- ( Azuree A+ (Powered by Panda Development) END )
end
...
local function PandaAuthentication(UserKey)
    local Hardware_ID = getHardwareId()
    ...
    if response and response.Body then
        ...
        if JsonData.Authenticated_Status == "Success" then
            local keyData = {
                Key = UserKey,
                ExpireAt = tostring(JsonData.Expire_Date),
                Premium = JsonData.Key_Premium or false
            }

            local jsonData = HttpService:JSONEncode(keyData)

            local success, error = pcall(function()
                writefile("AzureKey.json", jsonData)
            end)

            if not success then
                warn("[+] Failed to write key data: " .. tostring(error))
            end
        ...
        warn("[+] Azure A+ cannot connect to the server.")
        return "error"
    end
end
...
local function GenerateKey()
    local Hardware_ID = getHardwareId()
    return "https://new.pandadevelopment.net/getkey/" .. Identifier .. "?hwid=" .. Hardware_ID
end
...
-- Create buttons
local GetKeyButton = createButton("Get Key", UDim2.new(0, 0, 0, 0), Color3.fromRGB(0, 120, 212))
local LoginButton = createButton("Login", UDim2.new(0.52, 0, 0, 0), Color3.fromRGB(0, 120, 212))

-- Add button functionality
GetKeyButton.MouseButton1Click:Connect(function()
    -- Add your get key logic here
    setclipboard(GenerateKey())
